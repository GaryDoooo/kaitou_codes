...
class Player:
    ...
    def __str__(self):
        return f"Name: {self.name} Score: {self.score} Rerolls: {self.rerolls}"
    ...
    def take_turn(self):
        ...
        while True:
            ...
            # if the player has no self.rerolls, they're stuck with this
            if self.rerolls == 0:
                print("You're out of self.rerolls so you have to keep this.")
                break
            ...
            self.rerolls -= 1
            print("OK, you have " + str(self.rerolls) + " self.rerolls left.")

        self.score += roundScore  # update the self.score
