...
using namespace std;
ll w_sum[212345], c_sum[212345], d_sum[212345], res = ULLONG_MAX;
int w[212345], d[212345], n, f1, f2[212345];
...
int main() {
    ...
    for (int i = 3; i <= n; i++) {
        ...
        //     ll ext_c = now_c;
        //     found    = false;
        //     for (int j = now_f1 + 1; j < min(i, now_f1 + 10); j++) {
        //         ll temp = cost(1, j) + cost(j + 1, i);
        //         if (temp < now_c) {
        //             now_c  = temp;
        //             now_f1 = j;
        //             found  = true;
